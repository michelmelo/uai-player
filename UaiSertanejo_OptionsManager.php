...
class UaiSertanejo_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'uai-sertanejo'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'uai-sertanejo'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'uai-sertanejo'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'uai-sertanejo'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'uai-sertanejo');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'uai-sertanejo'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'uai-sertanejo');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'uai-sertanejo'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'uai-sertanejo') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'uai-sertanejo');
            case 'false':
                return __('false', 'uai-sertanejo');

            case 'Administrator':
                return __('Administrator', 'uai-sertanejo');
            case 'Editor':
                return __('Editor', 'uai-sertanejo');
            case 'Author':
                return __('Author', 'uai-sertanejo');
            case 'Contributor':
                return __('Contributor', 'uai-sertanejo');
            case 'Subscriber':
                return __('Subscriber', 'uai-sertanejo');
            case 'Anyone':
                return __('Anyone', 'uai-sertanejo');
        }
        return $optionValue;
    }
